...
public class Fragment_Mis_Recetas extends Fragment implements SearchView.OnQueryTextListener{
    public static Fragment_Mis_Recetas ma;
    private List<Receta> lista_Recetas;
    private RecyclerView recyclerView;
    private Adaptador_Mis_Recetas adapter;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.clear();
        inflater.inflate(R.menu.activity_access_recetas_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_agregar) {
            Intent intent = new Intent(getActivity(), Activity_Agregar.class);
            intent.putExtra("correo", Activity_Access.correo.getText().toString());
    ...
    public void refresh_list(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Configuration.URL_SELECT_FROM_USER, new Response.Listener<String>() {
            @Override
